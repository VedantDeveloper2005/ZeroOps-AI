...
export function createSimulatedDeploymentLines(repo = "acme/web-app"): TerminalLine[] {
  ...
  return [
    ...
    { text: "[Stage 2] Analyzing Application...", type: "info" },
    ...
    { text: "[Stage 3] Building Container...", type: "info" },
