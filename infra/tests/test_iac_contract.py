...
class InfrastructureContractTests(unittest.TestCase):
    ...
    def test_model_routes_use_separate_vaults_and_foundry_only(self) -> None:
        ...
        self.assertRegex(root, r"AI_REPOSITORY_PROVIDER\s*=\s*var\.repository_ai_provider")
        self.assertRegex(root, r"AI_TERRAFORM_PROVIDER\s*=\s*var\.terraform_ai_provider")
        self.assertRegex(root, r"AI_REPOSITORY_ENDPOINT\s*=\s*var\.repository_ai_endpoint")
        self.assertRegex(root, r"AI_TERRAFORM_ENDPOINT\s*=\s*var\.terraform_ai_endpoint")
        self.assertRegex(root, r"AI_REPOSITORY_MODEL\s*=\s*var\.repository_ai_model")
        self.assertRegex(root, r"AI_TERRAFORM_MODEL\s*=\s*var\.terraform_ai_model")
